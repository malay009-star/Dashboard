  ...
  return (
    <div className='container flex justify-center pt-10'>
      <form onSubmit={handleSubmit} className='w-full lg:w-[70%] primary_shadow px-6 pt-6 pb-7 rounded-md mb-8'>
        <h2 className='text-[22px] sm:text-[23px] font-medium'>Dog Information</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
          <div className=''>
            ...
            <input
              ...
              onBlur={handleBlur}
              className='bg-[#F5F5F5] rounded ps-3 pe-2 py-2 focus:outline-none w-full'
            />
        ...
        <div className='flex justify-end mt-5'>
          <button type='submit' className='font-light text-[15px] text-[#ffffff] bg-[#ea660b] px-6 py-[8px] rounded'>Send Dogs Info</button>
        </div>
      </form>
      <Toaster />
    </div>
